...
import ru.vladik.dnevnikru.dnevnikapi.exceptions.LoginException
import ru.vladik.dnevnikru.dnevnikapi.models.v7.FeedInfoPrototype
import ru.vladik.dnevnikru.dnevnikapi.models.v7.deserializers.FeedInfoDeserializer
import ru.vladik.dnevnikru.ext.http.addParam
...
/**
Провайдер API для Dnevnik.ru. Предоставляет методы для получения токена, создания клиента
для вызова API и другие вспомогательные функции.
 */
