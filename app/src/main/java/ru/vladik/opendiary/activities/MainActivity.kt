...
* ### Этот класс наследуется от класса [AppCompatActivity] и отвечает за создание и инициализацию главного экрана приложения. В методе [onCreate] происходит заполнение экрана и настройка навигации с помощью [BottomNavigationView] и [NavHostFragment].
